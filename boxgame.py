...
font96 = pygame.font.SysFont(None,72)
font72 = pygame.font.SysFont(None,32)
font64 = pygame.font.SysFont(None,32)
font56 = pygame.font.SysFont(None,24)

def res_page(player):
    res = True
    
    while res:
        screen.fill((251, 252, 251 ))
        ...
        rect = pygame.draw.rect(screen,(255,255,255),(width/2-60,height/2-50,120,60),10)
...
def main_screen(no_of_dots):
    ...
    while main:
        ...
        player1_text = font72.render('player 1 : '+str(player1_score),True,(3,3,3))
        player1_text_rect = player1_text.get_rect()
        player1_text_rect.center = (200,100)
        screen.blit(player1_text,player1_text_rect)
        
        player2_text = font72.render('player 2 : '+str(player2_score),True,(3,3,3))
        ...
        rect = pygame.draw.rect(screen,(255,255,255),(10,10,60,30),3)
        back_text = font56.render(' back',True,(255,255,255))
        back_text_rect = back_text.get_rect()
        back_text_rect.center = rect.center
        screen.blit(back_text,back_text_rect)
        ...
        if player==1:
            pygame.draw.circle(screen,(155,0,0),(300,100),10)
        else:
            pygame.draw.circle(screen,(0,0,255),(width-300,100),10)
        
        for sub_arr in player_name_arr:
            name_text = font72.render('P'+str(sub_arr[2]),True,(3,3,3))
        ...
        for i in range(no_of_dots):
            for j in range(no_of_dots-1):
                ...
                if mouse_pos[0]>cord[0]+15 and mouse_pos[0]<hr_next_cord[0]-15 and mouse_pos[1]>cord[1]-15 and mouse_pos[1]<cord[1]+15 :
        ...
        for i in range(no_of_dots-1):
           for j in range(no_of_dots):
               ...
               if mouse_pos[1]>cord[1]+15 and mouse_pos[1]<vr_next_cord[1]-15 and mouse_pos[0]>cord[0]-15 and mouse_pos[0]<cord[0]+15 :
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                for i in range(no_of_dots):
                    for j in range(no_of_dots-1):
                        ...
                        if event.pos[0]>cord[0]+15 and event.pos[0]<hr_next_cord[0]-15 and event.pos[1]>cord[1]-15 and event.pos[1]<cord[1]+15 and [ cord, hr_next_cord ] not in line_arr:
                ...
                for i in range(no_of_dots-1):
                   for j in range(no_of_dots):
                       ...
                       if event.pos[1]>cord[1]+15 and event.pos[1]<vr_next_cord[1]-15 and event.pos[0]>cord[0]-15 and event.pos[0]<cord[0]+15 and [ cord, vr_next_cord ] not in line_arr:
...
def hero_page():
    ...
    while hero:
        ...
        head_img_rect.center = (width/3,height/4+30)
        screen.blit(head_img,head_img_rect)
        
        des_img = font56.render('Line Vs Line',True,(0,0,0))
        des_img_rect = des_img.get_rect()
        des_img_rect.center = (width/3+108,height/4+65)
        screen.blit(des_img,des_img_rect)
        
        start_btn_rect = pygame.draw.rect(screen,(3,3,3),(width/4,height/2,120,60),10,20)
        up_btn_rect = pygame.draw.rect(screen,(3,3,3),(width/2+40,height/2-45,50,50),7,5)
        down_btn_rect = pygame.draw.rect(screen,(3,3,3),(width/2+40,height/2+45,50,50),7,5)
        
        start_btn_text = font72.render('start',True,(3,3,3))
        ...
        dots_text = font72.render('No of dots : '+str(no_of_dots)+'x'+str(no_of_dots),True,(3,3,3))
        dots_text_rect = dots_text.get_rect()
        dots_text_rect.center = (width/2,height/2+30)
        screen.blit(dots_text,dots_text_rect)
        
        up_btn_text = font96.render('-',True,(3,3,3))
        up_btn_text_rect = up_btn_text.get_rect()
        up_btn_text_rect.center = up_btn_rect.center
        screen.blit(up_btn_text,up_btn_text_rect)
        
        down_btn_text = font96.render('+',True,(3,3,3))
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if event.pos[0]>up_btn_rect.x and event.pos[1]>up_btn_rect.y and event.pos[0]<(up_btn_rect.x+up_btn_rect.width) and event.pos[1]<(up_btn_rect.y+up_btn_rect.height) and no_of_dots>3:
                    pygame.draw.rect(screen,(255,255,255),(width/2+40,height/2-45,50,50),50,5)
                    no_of_dots -= 1
